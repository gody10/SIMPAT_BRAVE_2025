...
def plot_graphs(folder_for_pure_learning= 'plots/pure_learning'):
	...
	plt.ylabel('Total Bits Processed', fontsize=38, fontweight='bold')
	...
	plt.ylabel('Energy Expended', fontsize=38, fontweight='bold')
	...
	# Set the y-axis label
	plt.ylabel('Total Visited Nodes', fontsize=38, fontweight='bold')
	...
	# Set the y-axis label
	plt.ylabel('(B*AoI)/E', fontsize=38, fontweight='bold')
