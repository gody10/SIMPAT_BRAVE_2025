...
class Qenv(gym.Env):
	...
	def step(self, action: Node) -> Tuple[Node, float, bool, dict]:
		...
		uav_bandwidth = self.uav.get_uav_bandwidth()
		uav_cpu_frequency = self.uav.get_cpu_frequency()
		uav_total_data_processing_capacity = self.uav.get_total_data_processing_capacity()
