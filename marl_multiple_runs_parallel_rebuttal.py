...
multi_q_learning_logger = setup_logger('multi_q_learning_rebuttal', 'multi_q_learning_rebuttal.log')
...
def main():
    ...
    with ProcessPoolExecutor(max_workers=10) as executor:
        ...
        for future in tqdm(as_completed(futures), total=TOTAL_RUNS, desc="Running Experiments"):
            ...
            if completed_runs % CHECKPOINT_INTERVAL == 0:
                ...
                os.remove('multi_q_learning_total_bits_rebuttal.pkl') if os.path.exists('multi_q_learning_total_bits_rebuttal.pkl') else None
                os.remove('multi_q_learning_expended_energy_rebuttal.pkl') if os.path.exists('multi_q_learning_expended_energy_rebuttal.pkl') else None
                os.remove('multi_q_learning_total_visited_nodes_rebuttal.pkl') if os.path.exists('multi_q_learning_total_visited_nodes_rebuttal.pkl') else None
                os.remove('multi_q_learning_timers_rebuttal.pkl') if os.path.exists('multi_q_learning_timers_rebuttal.pkl') else None
                
                # Save the averaged data to pickle files
                save_pickle(avg_total_bits, 'multi_q_learning_total_bits_rebuttal.pkl')
                save_pickle(avg_expended_energy, 'multi_q_learning_expended_energy_rebuttal.pkl')
                save_pickle(avg_total_visited_nodes, 'multi_q_learning_total_visited_nodes_rebuttal.pkl')
                save_pickle(avg_timers, 'multi_q_learning_timers_rebuttal.pkl')
                
                # Save them also in the checkpoint directory
                save_pickle(avg_total_bits, checkpoint_dir + 'multi_q_learning_total_bits_rebuttal.pkl')
                save_pickle(avg_expended_energy, checkpoint_dir + 'multi_q_learning_expended_energy_rebuttal.pkl')
                save_pickle(avg_total_visited_nodes, checkpoint_dir + 'multi_q_learning_total_visited_nodes_rebuttal.pkl')
                save_pickle(avg_timers, checkpoint_dir + 'multi_q_learning_timers_rebuttal.pkl')
    ...
    # Save the averaged data to pickle files
    save_pickle(final_avg_total_bits, 'multi_q_learning_total_bits_rebuttal.pkl')
    save_pickle(final_avg_expended_energy, 'multi_q_learning_expended_energy_rebuttal.pkl')
    save_pickle(final_avg_total_visited_nodes, 'multi_q_learning_total_visited_nodes_rebuttal.pkl')
    save_pickle(final_avg_timers, 'multi_q_learning_timers_rebuttal.pkl')
    
    # Save them also in the final output directory
    save_pickle(final_avg_total_bits, final_output_dir + 'multi_q_learning_total_bits_rebuttal.pkl')
    save_pickle(final_avg_expended_energy, final_output_dir + 'multi_q_learning_expended_energy_rebuttal.pkl')
    save_pickle(final_avg_total_visited_nodes, final_output_dir + 'multi_q_learning_total_visited_nodes_rebuttal.pkl')
    save_pickle(final_avg_timers, final_output_dir + 'multi_q_learning_timers_rebuttal.pkl')
